...
public class DynamicArrayJava {
	...
	public static void main(String[] args) {
		DynamicArrayJava dynamicArray = new DynamicArrayJava();
		// adding elements to the array
		dynamicArray.addElement(12);
		dynamicArray.addElement(22);
		dynamicArray.addElement(35);
		dynamicArray.addElement(47);
		dynamicArray.addElement(85);
		dynamicArray.addElement(26);
		dynamicArray.addElement(70);
		dynamicArray.addElement(81);
		dynamicArray.addElement(96);
		dynamicArray.addElement(54);
		...
		System.out.println("Size of the array: " + dynamicArray.sizeofarray);
		System.out.println("No. of elements in the array: " + dynamicArray.count);
		...
		// determines and prints the size and number of elements of the array
		System.out.println("Size of the array: " + dynamicArray.sizeofarray);
		System.out.print("No. of elements in the array: " + dynamicArray.count + "\n");
		// invoking the method that deletes an element from the specified index
		dynamicArray.removeElementAt(7);
